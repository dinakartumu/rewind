...
You can also explore your collection from Claude. Set up the [MCP server](/mcp/overview) and ask in natural language, like what is in your collection or which records you own but have never played. Claude answers by querying the [database directly with SQL](/mcp/overview).
