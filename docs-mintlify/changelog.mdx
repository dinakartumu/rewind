...
<Update label="July 25, 2026" tags={["New features", "Improvements"]}>
...
<Update label="July 22, 2026" tags={["New releases", "New features"]}>
...
- [`GET /v1/places/recent`](/api-reference/places/recent-check-ins) — check-ins newest first, with pagination and date filters.
- [`GET /v1/places/stats`](/api-reference/places/check-in-stats) — totals, unique venues, this-year count, and top categories, cities, and venues, each with a category icon.
- [`GET /v1/places/trends`](/api-reference/places/check-in-trends) — monthly check-in counts over time.
- See [Places domain](/domains/places).

</Update>

<Update label="July 22, 2026" tags={["New releases", "Improvements"]}>
...
<Update label="July 22, 2026" tags={["New features", "Improvements"]}>
...
- Filter by `city` on [`GET /v1/running/activities`](/api-reference/running/list-activities), and browse the [cities endpoint](/api-reference/running/cities). See [Running domain](/domains/running).
