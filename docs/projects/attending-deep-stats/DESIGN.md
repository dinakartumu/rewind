...
| `summary`                                  | Yes — pre-formatted human string per game | Pre-formatted (e.g. `"1-4 \| K"`, `"7.0 IP, 2 ER, 6 K, BB"`). Useful for the game card top-performers panel without computing anything.                                                                            |
