...
const U = 'https://rewind.dinakartumu.com',
  K = 'rw_a9055419df2d08161a4619bbf5f89b186a90ef5c';
async function q(sql) {
  const r = await fetch(U + '/v1/query', {
    method: 'POST',
    headers: {
