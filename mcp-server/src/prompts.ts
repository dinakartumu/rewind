      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              '- The confirmed match: title, author, source domain, a one-sentence summary drawn verbatim from the excerpt, and the article URL',
              '- 3-5 related pieces (only if match is confirmed)',
              '',
