...
for (const entry of entries) {
  ...
  execSync(
    `INPUT=${entry} vite build --config web/vite.config.ts`,
...
function toConstName(filename) {
  ...
  return (
    base.toUpperCase().replace(/[^A-Z0-9]+/g, '_').replace(/^_|_$/g, '') +
    '_HTML'
  );
}

const built = readdirSync(distDir).filter((f) => f.endsWith('.html'));
const parts = ['// Auto-generated by scripts/inline-bundles.mjs -- do not edit.'];
const manifest = [];
